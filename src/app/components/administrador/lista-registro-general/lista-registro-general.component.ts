...
import { RegistroAdminService } from 'src/app/services/registro-admin/registro-admin.service';
@Component({
  selector: 'app-lista-registro-general',
  standalone: true,
  imports: [CommonModule, FormsModule, IonicModule],
  templateUrl: './lista-registro-general.component.html',
  styleUrls: ['./lista-registro-general.component.scss'],
})
export class ListaRegistroGeneralComponent implements OnInit {
  visitas: any[] = [];
...
cargarVisitas() {
  this.registroAdminService.obtenerTodasLasVisitas().subscribe({
    next: (res) => {
